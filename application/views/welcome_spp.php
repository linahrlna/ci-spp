...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/css/dore.light.yellowgranola.css'); ?>" />
        <link rel="stylesheet" href="<?php echo base_url('assets/css/dore.light.yellowgranola.min.css'); ?>" />
